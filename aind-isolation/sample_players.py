...
class CompPlayer1(game_agent.AlphaBetaPlayer):
    pass

class CompPlayer2(game_agent.AlphaBetaPlayer):
    pass
...
if __name__ == "__main__":
    ...
    player1 = CompPlayer1() #GreedyPlayer()
    player2 = CompPlayer2(score_fn=improved_score)
    ...
    #print("Player 2 legal moves: ", game.get_legal_moves(player2))
    #time_limit = 150.
    #time_millis = lambda: 1000 * timeit.default_timer()
    #move_start = time_millis()
    #time_left = lambda : time_limit - (time_millis() - move_start)
    #print("P1 next move: ", player1.get_move(game, time_left))

    # get a successor of the current state by making a copy of the board and
    # applying a move. Notice that this does NOT change the calling object
    # (unlike .apply_move()).
    #new_game = game.forecast_move((2, 4))
